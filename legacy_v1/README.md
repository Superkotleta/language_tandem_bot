...
- **Система доступности** - настройка времени и предпочтений общения
...
| **[AVAILABILITY_SYSTEM.md](AVAILABILITY_SYSTEM.md)** | Система доступности и предпочтений | ✅ Актуально |
