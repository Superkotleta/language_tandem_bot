...
-- Переводы интересов
-- Сначала удаляем существующие переводы, чтобы избежать конфликтов COALESCE
DELETE FROM interest_translations;
...
现在选择你想学习的语言：', 'language_selection'),
    ...
    -- Языки для кнопок
    ('language_ru', 'ru', '🇷🇺 Русский', 'interface'),
    ('language_ru', 'en', '🇷🇺 Russian', 'interface'),
    ('language_ru', 'es', '🇷🇺 Ruso', 'interface'),
    ('language_ru', 'zh', '🇷🇺 俄语', 'interface'),
    
    ('language_en', 'ru', '🇺🇸 Английский', 'interface'),
    ('language_en', 'en', '🇺🇸 English', 'interface'),
    ('language_en', 'es', '🇺🇸 Inglés', 'interface'),
    ('language_en', 'zh', '🇺🇸 英语', 'interface'),
    
    ('language_es', 'ru', '🇪🇸 Испанский', 'interface'),
    ('language_es', 'en', '🇪🇸 Spanish', 'interface'),
    ('language_es', 'es', '🇪🇸 Español', 'interface'),
    ('language_es', 'zh', '🇪🇸 西班牙语', 'interface'),
    
    ('language_zh', 'ru', '🇨🇳 Китайский', 'interface'),
    ('language_zh', 'en', '🇨🇳 Chinese', 'interface'),
    ('language_zh', 'es', '🇨🇳 Chino', 'interface'),
    ('language_zh', 'zh', '🇨🇳 中文', 'interface')
