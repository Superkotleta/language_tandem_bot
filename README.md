...
cd language_exchange_bot/services

# 2. Автоматическая настройка оптимизированной версии
make optimized-dev
```
...
```bash
# Показать инструкции для production
make optimized-production-guide
```

#### 📖 Подробные инструкции

- [Quick Start Guide](services/QUICK_START.md) - Быстрый старт
- [Production Deployment](services/deploy/docs/PRODUCTION_DEPLOYMENT.md) - Production развертывание
